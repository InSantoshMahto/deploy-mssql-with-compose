...
quick-ref: ## Quick reference for Podman-specific SQL Server management
	...
	@echo "   $(GREEN)journalctl -u sqlserver$(NC)     - View systemd journal logs"
	@echo ""
	...
	@echo "     $(GREEN)podman logs sqlserver$(NC)"
	@echo "     $(GREEN)journalctl -u sqlserver -f -n 50$(NC)"
	@echo ""
...
show-notes: ## Display important Podman-specific notes and considerations
	...
	@echo "     • $(GREEN)podman logs -f sqlserver$(NC) (standard)"
	@echo "     • $(GREEN)journalctl -u sqlserver -f -n 50$(NC) (systemd journal)"
	@echo ""
